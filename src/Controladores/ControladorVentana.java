            ...
            if (ae.getSource()==interfazVen.getEditContacto()) {
                ...
                if (fila == -1){
                    ...
                    try {
                        ...
                        new ControladorEditarContacto((String)dt.getValueAt(fila, 0),(String)dt.getValueAt(fila, 1),(String)dt.getValueAt(fila, 2),(String)dt.getValueAt(fila, 3),id);
                    } catch (SQLException ex) {
                        Logger.getLogger(ControladorVentana.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            ...
            if (ae.getSource()==interfazVen.getElimContacto()) {
                ...
                if (fila == -1){
                    ...
                    try {
                        ...
                        new ControladorElimContacto((String)dt.getValueAt(fila, 0),(String)dt.getValueAt(fila, 1));
                    } catch (SQLException ex) {
                        Logger.getLogger(ControladorVentana.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
